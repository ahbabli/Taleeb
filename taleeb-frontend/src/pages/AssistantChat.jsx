...
const quickQuestions = [
  ...
  {
    text: "How can I view today’s schedule?",
    icon: CalendarDays,
  },
  {
    text: "Where can I find university announcements?",
    icon: HelpCircle,
  },
];
  ...
  return (
    <div className="h-[100dvh] overflow-hidden bg-white px-4 pt-4 pb-24 sm:px-5 sm:pt-5 sm:pb-28">
      <div className="mx-auto flex h-full max-w-4xl flex-col gap-3 sm:gap-4">
            ...
            {quickQuestions.map((item) => {
              ...
              return (
                <button
                  key={item.text}
                  type="button"
                  onClick={() => askAssistant(item.text)}
                  disabled={loading}
                ...
                >
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[#EAF3FF] text-[#1557A6] sm:h-9 sm:w-9">
                    <Icon size={18} />
                  </span>
        ...
        <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[1.5rem] border border-blue-100 bg-white shadow-sm sm:rounded-[2rem]">
          <div className="shrink-0 flex items-center justify-between border-b border-blue-100 bg-white px-4 py-3 sm:px-5">
            <div className="flex items-center gap-3">
              <span className="relative flex h-10 w-10 items-center justify-center rounded-2xl bg-[#EAF3FF] text-[#1557A6]">
                <Bot size={21} />
          ...
          <div className="min-h-0 flex-1 overflow-y-auto bg-gradient-to-b from-white to-[#F8FAFF] p-4 sm:p-5">
            ...
            {loading && (
              <div className="flex items-end gap-3">
                ...
                <div className="flex items-center gap-2 rounded-2xl rounded-bl-md bg-[#EAF3FF] px-4 py-3 text-sm font-bold text-[#0B3D7A]">
          ...
          >
            <div className="flex items-end gap-3 rounded-2xl border border-blue-100 bg-[#F8FAFF] p-2 transition focus-within:border-[#1557A6] focus-within:ring-4 focus-within:ring-blue-100">
              <textarea
                value={question}
